...
_SENSOR_LIST: list[FemsSensorDescription] = [
    ...
    FemsSensorDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        value_fn=lambda c: c.data.rest.get("charger0/ActualPower"),
    ),
    FemsSensorDescription(
        ...
        device_class=SensorDeviceClass.VOLTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        value_fn=lambda c: c.data.rest.get("charger0/Voltage"),
    ),
    FemsSensorDescription(
        ...
        device_class=SensorDeviceClass.CURRENT,
        state_class=SensorStateClass.MEASUREMENT,
        value_fn=lambda c: c.data.rest.get("charger0/Current"),
    ),
    FemsSensorDescription(
        key="charger1_power",
        ...
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        value_fn=lambda c: c.data.rest.get("charger1/ActualPower"),
    ),
    FemsSensorDescription(
        ...
        device_class=SensorDeviceClass.VOLTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        value_fn=lambda c: c.data.rest.get("charger1/Voltage"),
    ),
    FemsSensorDescription(
        ...
        device_class=SensorDeviceClass.CURRENT,
        state_class=SensorStateClass.MEASUREMENT,
        value_fn=lambda c: c.data.rest.get("charger1/Current"),
    ),
    FemsSensorDescription(
        key="ess_soc_modbus",
